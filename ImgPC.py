...
def degree_comp(degree, COMP_ORDER=3, COMP_CONSTANT=0.1, COMP_CONSTANT2=0):
    #complements a degree
    #returns the complemented degree
    compensated_degree = COMP_CONSTANT2*degree + COMP_CONSTANT*degree**COMP_ORDER
